...
3. Present the requirements to the user (show the file content or a tight summary) and ask directly: *"Do you approve these requirements, or would you like changes?"*
...
3. Present the design (and, if one was produced, the wireframe) to the user and ask directly: *"Do you approve this design, or would you like changes?"* Treat wireframe approval and design.md approval as one combined checkpoint — don't finalize Phase 2 with an approved design.md sitting alongside a still-unapproved wireframe.
