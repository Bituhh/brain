...
Raw data tables for [`findings.md`](../findings.md) finding 9 — Self-tuning k-WTA sparsity (inhibition-homeostasis spec, Requirement 1): no effect at.

---

| targetRate | smoothing | adjustmentRate | minK | intervalTicks | seeds | mean network accuracy | range across seeds |
| --- | --- | --- | --- | --- | --- | --- | --- |
| _(mechanism disabled — item 8's 17.37% baseline)_ | — | — | — | — | 5 | 17.37% | — |
